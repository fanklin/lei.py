...
SECRET_KEY = 'lzm+(xek!c5m+px=(m)d0c=wv0-$9hii7wbd(a(64mw_z&*vk_'
...
EMAIL_HOST_USER = 'daliyfresh@163.com'       # 发件人（天天生鲜官方邮箱账号）
EMAIL_HOST_PASSWORD = 'ha123456'           # 邮箱客户端授权码，非邮箱登录密码
EMAIL_FROM = '天天生鲜<daliyfresh@163.com>'   # 收件人接收到邮件后，显示在‘发件人’中的内容，如下图
